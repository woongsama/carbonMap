...
<script type="text/javascript">
    ...
    // 레이어 이름 (범례유형에 따라 다르게 출력)
    if(legend_type == 'natural'){
    	var search_layerName = 'carbon:view_carbon_c_sgg';
    }else{
    	var search_layerName = 'carbon:view_carbon_c_sgg_equal';
    }
    ...
    var desiredZoomLevel = 7;
   	...
   	var param1Value = '${sd_nm}';
   	console.log('pram1Value:'+param1Value);
   	var param2Value = '';
    
//  var multiparams = 'LEGEND2:${legend2};LEGEND1:${legend1};LEGEND4:${legend4};LEGEND3:${legend3};LEGEND5:${legend5};SDNM:${sd_nm}';
    ...
    var geoTile = new ol.layer.Tile({
    	source: new ol.source.TileWMS({
    		...
    		params:{
                ...
                "LAYERS": search_layerName,
                'viewparams' : 'SDNM:'+param1Value,
                'propertyName': 'sgg_usage' // 필터링할 컬럼 이름
    		},
    		serverType: 'geoserver',
    	})
    });
